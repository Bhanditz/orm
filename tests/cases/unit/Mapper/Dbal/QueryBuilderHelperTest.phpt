...
class QueryBuilderHelperTest extends TestCase
{
	...
	public function testOneHasManyAndManyHasMany()
	{
		...
		$reflection = new \ReflectionMethod($this->builderHelper,'processPropertyWithValueExpr');
		$reflection->setAccessible(true);
		list($columnExpr, $convertedValue) = $reflection->invoke($this->builderHelper, $this->queryBuilder, 'this->translatedBooks->tags->name', ['tag_name']);
